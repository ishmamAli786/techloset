        ...
        <DialogContent dividers>
          <form>
              <div style={{display:"flex",justifyContent:"space-between"}}>
                  <label>Email</label>
                  <input type="email" style={{width:"80%",padding:"9px"}}></input>
              </div><br></br>

              <div style={{display:"flex",justifyContent:"space-between"}}>
                  <label>Skype id</label>
                  <input type="text" style={{width:"80%",padding:"9px"}}></input>
              </div><br></br>


              <div style={{display:"flex",justifyContent:"space-between"}}>
                  <label>GitHub <br></br>Profile Link</label>
                  <input type="text" style={{width:"82%"}}></input>
              </div>
